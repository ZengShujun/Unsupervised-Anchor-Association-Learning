...
# =============================================================================
#         if args.reset:  #delete all files
#             os.system('rm -rf ' + self.dir)
#             args.load = ''
# =============================================================================
## Above ,get save/load address
        def _make_dir(path):
...
#        torch.save(trainer.loss.log, os.path.join(self.dir, 'map_log.pt'))
    ...
    def write_log(self, log, refresh=True, end='\n'):
        print(log, end=end)
        if end != '':
